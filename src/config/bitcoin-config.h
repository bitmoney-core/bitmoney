...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitmoney Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitmoney Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitmoney-project/bitmoney/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitmoney Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitmoney Core 0.16.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitmoney"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitmoney.org/"
