...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitmoney-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitmoney-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitmoney transaction") + "\n" +
              "  bitmoney-tx [options] -create [commands]   " + _("Create hex-encoded bitmoney transaction") + "\n" +
              "\n";
