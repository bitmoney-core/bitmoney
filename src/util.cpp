...
const char * const BITCOIN_CONF_FILENAME = "bitmoney.conf";
const char * const BITCOIN_PID_FILENAME = "bitmoneyd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitmoney";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitmoney";
#else
    // Unix
    return pathRet / ".bitmoney";
#endif
#endif
}
