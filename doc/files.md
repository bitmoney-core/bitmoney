...
* bitmoney.conf: contains configuration settings for bitmoneyd or bitmoney-qt
* bitmoneyd.pid: stores the process id of bitmoneyd while running
...
* debug.log: contains debug information and general logging generated by bitmoneyd or bitmoney-qt
