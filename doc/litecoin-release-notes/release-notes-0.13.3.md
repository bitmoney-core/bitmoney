Bitmoney Core version 0.13.3 is now available from:

  <https://download.bitmoney.org/bitmoney-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/bitmoney-project/bitmoney/blob/0.13/src/chainparams.cpp#L214).
